...
function addMatrices(matrix1, matrix2) {
    if (matrix1.length !== matrix2.length || matrix1[0].length !== matrix2[0].length) {
        document.getElementById('matrix3').innerHTML = "Matrices must be of the same size for adding.";
        return;
    }
...
const subtractMatrices = function (matrix1, matrix2) {
    if (matrix1.length !== matrix2.length || matrix1[0].length !== matrix2[0].length) {
        document.getElementById('matrix3').innerHTML = "Matrices must be of the same size for subtraction.";
        return;
    }
...
const multiplyMatrices = (matrix1, matrix2) => {
    if (matrix1[0].length !== matrix2.length) {
        document.getElementById('matrix3').innerHTML = "The number of columns in the first matrix must be equal to the number of rows in the second matrix";
        return;
    }
